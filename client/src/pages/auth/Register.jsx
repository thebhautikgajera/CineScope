          ...
          <div className="border-t border-white/5 bg-transparent p-8 text-text sm:p-12 lg:border-l lg:border-t-0">
            <div className="mb-10 space-y-3">
              ...
              <p className="text-sm text-white/65 sm:text-base">
                {step === 1
                  ? 'Start with your email and phone so we can secure your CineScope account.'
                ...
                <>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-medium text-white/50">India (+91)</span>
                    </div>
                    <div className="flex rounded-xl border border-white/15 bg-white/5 focus-within:border-highlight/70 focus-within:ring-2 focus-within:ring-highlight/30">
                      <span
                        className={`flex items-center rounded-l-xl border-r px-3 text-sm font-semibold transition-all ${phone.length === 10
                      ...
                      <div className="relative flex-1">
                        <input
                          ...
                          disabled={loading}
                          maxLength={10}
                          className="w-full rounded-r-xl border-0 px-4 py-3 pr-12 text-base text-white placeholder:text-white/40 focus:outline-none bg-transparent"
                        />
                        {phone.length === 10 && (
                    ...
                    {fieldErrors.phone && (
                      <p className="text-sm font-medium text-red-400">{fieldErrors.phone}</p>
                    )}
                    {!fieldErrors.phone && phone.length > 0 && phone.length < 10 && (
                      <p className="text-sm font-medium text-red-400">
                        Phone number must be exactly 10 digits
                      </p>
                    )}
                    {phone.length === 10 && (
                      <p className="text-sm font-medium text-emerald-400">Phone number is valid</p>
                    )}
                  </div>
                </>
              )}
              ...
              <div className="flex gap-3">
                ...
                {step === 1 ? (
                  <button
                    ...
                    disabled={loading || phone.length !== 10 || !validateEmail(email)}
                  >
                    Continue
                  </button>
                ) : (
